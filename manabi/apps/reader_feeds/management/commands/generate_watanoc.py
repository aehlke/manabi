...
from manabi.apps.reader_feeds.watanoc import generate_feed
...
class Command(BaseCommand):
    ...
    async def run(self, *args, **options):
        ...
        for jlpt_level in ['n5', 'n4', 'n3']:
            xml = await generate_feed(jlpt_level, **feed_kwargs)
            ...
            if options['dev']:
                ...
                save_feed(f'watanoc-{jlpt_level}.rss', xml)
